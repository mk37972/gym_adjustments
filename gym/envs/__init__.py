...
for reward_type in ['sparse', 'dense']:
    ...
    register(
        id='FetchPickAndPlaceFragile{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchPickAndPlaceFragileEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )

    register(
        id='FetchPickAndPlaceFragile{}-v2'.format(suffix),
        entry_point='gym.envs.robotics:FetchPickAndPlaceFragileEnv2',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    ...
    register(
        id='HandManipulateWallTouchSensors{}-v0'.format(suffix),
        entry_point='gym.envs.robotics:HandWallTouchSensorsEnv',
        kwargs=_merge({'target_position': 'random', 'target_rotation': 'xyz', 'touch_get_obs': 'sensordata'}, kwargs),
        max_episode_steps=50,
    )
