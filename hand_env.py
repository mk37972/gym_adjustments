...
class HandEnv(robot_env.RobotEnv):
    def __init__(self, model_path, n_substeps, initial_qpos, relative_control, nAction):
        self.relative_control = relative_control
        self.nAction = nAction

        super(HandEnv, self).__init__(
            model_path=model_path, n_substeps=n_substeps, n_actions=nAction,
    ...
    def _set_action(self, action):
        assert action.shape == (self.nAction,)
